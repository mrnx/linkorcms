...
function AdminFdbAdminGenTableMenu( $name ){
	global $action;
	System::admin()->SideBarAddMenuItem('Структура', 'exe=fdbadmin&a=structure&name='.$name, 'structure');
	System::admin()->SideBarAddMenuItem('Обзор', 'exe=fdbadmin&a=review&name='.$name, 'review');
