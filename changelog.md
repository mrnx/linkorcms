...
Версия 1.3.5 (18.09.2011)
-------------------------
* Фильтр HEAD запросов. Были проблемы в некоторых браузерах.
* Исправлена ошибка в  .htaccess, при работе из поддиректории.
* Обновлен шаблон original.
* Обновлен TinyMCE.
* Исправлено большинство ошибок в ImagesManager.
* Повышена надежность файловой базы данных. Изменен способ блокировки файлов при записи.
* Исправлена генерация ссылок в рефералах.
* Исправлена ошибка, на форуме в блоке онлайн генерировались неправильные ссылки на профили пользователей.
* Исправлена ошибка, на форуме при просмотре всех тем пользователя не отображались блоки статистики и онлайн.
* Исправлен подсчет тем в блоке статистики.
* Исправлена транслитерация заголовка в ссылку, в модуле Страницы.
* Исправлены ошибки при отправке писем через SMTP.
