...
$system_files = array(
	...
	'email.php','errors.php','filesystem.php','forms.php','images.php',
	'location.php','plugins.php','plugins_system.php','request.php','scripts.php',
	'search.php','smilies.php','string.php','translit.php','ufu.php',
	'url.php','user.php','utf8.php',
);