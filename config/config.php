...
define('BUILD_SYSTEM_WITH_CLASSES', true); // Собирать ядро вместе со всеми классами
define('LOAD_SYSTEM_APART', true); // Загружать каждый модуль ядра отдельно (для отладки)
